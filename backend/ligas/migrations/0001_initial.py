    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_invitacion', models.CharField(choices=[('Pendiente', 'Pendiente'), ('Aceptada', 'Aceptada'), ('Rechazada', 'Rechazada'), ('Expirada', 'Expirada')], default='Pendiente', max_length=50)),
                ('mensaje_invitacion', models.TextField(blank=True, null=True)),
                ('email_invitado', models.EmailField(blank=True, max_length=100, null=True)),
            ],
            options={
                'db_table': 'invitacion',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monto_total_recaudado', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_participacion', models.CharField(default='Activo', max_length=50)),
            ],
            options={
