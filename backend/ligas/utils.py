...
def obtener_ligas_usuario_ids(usuario_id: int) -> Set[int]:
    """IDs de las ligas donde el usuario es admin, participante activo o tiene invitación válida."""
    ...
    return set(ligas_admin) | set(ligas_participante) | set(ligas_invitacion)
